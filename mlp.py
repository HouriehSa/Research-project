...
class TF_MLP(tf.keras.Model):
    def __init__(self):
        ...
        self.model = tf.keras.Sequential([
            tf.keras.layers.Dense(32, activation='relu', input_shape=(11,1)),
...
# Wrap the model in a Sequential model for summary
wrapped_model = Sequential([tf_model])

# Build the model
wrapped_model.build(( 11,))  # Set the input shape
